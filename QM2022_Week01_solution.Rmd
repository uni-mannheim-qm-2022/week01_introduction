...
my_lucky_number <- 23 # This is my lucky number
my_firstname <- "Oliver" # This is my first name
my_lastname <- "Rittmann" # This is my last name

# here, I call the new objects
my_lucky_number
my_firstname
my_lastname
```
...
# b) select elements of `vec1` that are greater than 5 or smaller than 0.
vec1[vec1 > 5 | vec1 < 0]

# c) set `vec1` to zero if `vec2` is greater than 30 and smaller or equal to 32.
...
# b) Generate a new variable and call it `hot` that is zero for 
# *mean temperature* < 10 and 1 for *mean temperature* > 10 degree Celsius.
weather_data$hot <- 0
weather_data$hot[weather_data$mean_temp > 10] <- 1
...
# hottest city
weather_data[weather_data$mean_temp == max(weather_data$mean_temp),]

# coldest city
weather_data[weather_data$mean_temp == min(weather_data$mean_temp),]
```
