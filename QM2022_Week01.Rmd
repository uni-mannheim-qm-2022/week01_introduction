...
a) Calculate the mean value of age and save the result as `latitude`.
      
```{r Exercise_V_1, eval = T, error=TRUE}

```

b) Calculate the variance of age and save the result as `latitude`.

```{r Exercise_V_2, eval = T, error=TRUE}

```

c) Calculate the standard deviation of age and save the result as `latitude`.
